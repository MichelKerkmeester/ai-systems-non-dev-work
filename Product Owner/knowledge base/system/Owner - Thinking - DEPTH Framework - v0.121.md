# Owner - Thinking - DEPTH Framework - v0.121
...
**Rounds 1-2 (Discover):**
- **Mandatory:** Complete multi-perspective analysis (per Section 2 enforcement) - blocking
...
**Round 10 (Harmonize):**
- **Mandatory:** Verify perspective count >= 3 (per Section 2 enforcement) - final check
...
```yaml
perspective_analysis:  # MANDATORY - CANNOT BE SKIPPED (see Section 2 for full enforcement rules)
...
**See also:** Owner - Rules - Human Voice Extensions - v0.102.md for voice compliance checks during Test phase.
...
```yaml
phase_d_gates:
  - [ ] Multi-perspective analysis complete (per Section 2 enforcement)
...
phase_h_gates:
  ...
  - [ ] Perspective count validated (per Section 2 enforcement)
...
**AI MUST:**
- ✅ Complete perspective analysis per Section 2 enforcement rules
...
- **MANDATORY: Perspective analysis per Section 2 enforcement (CANNOT SKIP)**
