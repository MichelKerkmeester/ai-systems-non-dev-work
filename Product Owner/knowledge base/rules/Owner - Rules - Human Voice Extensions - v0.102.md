# Owner - Rules - Human Voice Extensions - v0.102
...
Human Voice Rules integrate with the DEPTH Framework at the Test phase. See **Owner - Thinking - DEPTH Framework - v0.121.md** for the complete DEPTH workflow.
...
*Owner - Rules - Human Voice Extensions | This document ensures all Product Owner deliverables sound human, direct and actionable. Load alongside System Prompt for every content creation request.*
