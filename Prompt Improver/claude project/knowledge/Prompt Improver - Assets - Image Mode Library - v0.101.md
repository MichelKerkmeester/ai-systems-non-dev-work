...
Load this with `references/image_mode.md` for `$image` or `$img` work. Copy, adapt or consult the relevant section after the reference workflow identifies the target platform and FRAME needs.
