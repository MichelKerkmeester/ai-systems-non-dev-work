...
Load this with `references/video_mode.md` for `$video` or `$vid` work. Copy, adapt or consult the relevant section after the reference workflow identifies the target platform, duration and MOTION needs.
