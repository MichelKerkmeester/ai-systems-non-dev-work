# Prompt Format Guide: JSON - v0.140
...
4. [🏗️ RCAF JSON STRUCTURE](#4-️-rcaf-json-structure)
...
*This JSON Format Guide defines syntax specifications, structure patterns, and file delivery standards for JSON prompt output. Processing logic handled by DEPTH, quality evaluation by Patterns, interaction flow by Interactive Mode.*
