...
- [1. 🏗️ FRAMEWORK OVERVIEW](#1--framework-overview)
- [2. 🔄 DEPTH PHASES](#2--depth-phases)
- [3. 🧠 COGNITIVE RIGOR](#3--cognitive-rigor)
- [4. 📊 CLEAR SCORING & INTEGRATION](#4--clear-scoring--integration)
...
| Technique | Output |
|---|---|
| **Constraint Reversal** | ID conventional approach → Define opposite → Analyse mechanism → Find minimal flip → Apply | Non-obvious insights |
| **Divergent Thinking** | Framework patterns, Clarity improvements, Structure optimisations, Expression enhancements | 8+ approaches |
| **Framework Fit** | Assess best framework for use case (not most complex) | Selected framework |
| **Optimisation** | Select highest CLEAR score approach | ONE enhanced prompt |
| **Assumption Audit** | Continuous: classify [validated, questionable, unknown] | Flagged assumptions |
...
|---|---|---|
| **Discover** | Perspectives analysed per energy level, inversion applied, assumptions flagged, framework selected | All → Engineer |
| **Engineer** | Framework selected, reversal applied, 8+ approaches evaluated | All → Prototype |
| **Prototype** | Structure built, mechanism-first validated (WHY→WHAT), format applied | All → Test |
...
| Prototype | Mechanism First validation, assumption flagging | Structure building (WHY→WHAT) |
...
| Range | Status | Action |
|---|---|---|
| 40-50 | PASS | Proceed to Harmonise. Top-tier deliverable. |
...
| **External** | User visibility | Phase progress with emoji indicators, key insights (1-2 sentences), scores (before/after), critical flags, framework selection with reasoning |
...
| Scope Discipline | Only deliver what user requested, no feature invention | Remove additions |
