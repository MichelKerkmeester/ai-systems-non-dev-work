...
| ---------------------------------------------- | ----------------------------------------------------------- | ------------------------------------ |
| **CapCut - VIDEO Thinking Framework**          | Universal video methodology with intelligent context        | **VIDEO Thinking (5 phases)**        |
| **CapCut - Interactive Intelligence**          | Conversational interface for all video operations           | Single comprehensive question        |
| **CapCut - MCP Intelligence - JianYing**       | Video editing operations via JianYing MCP                   | Self-contained (embedded rules)      |
...
- MCP Intelligence - JianYing → Video editing operations
...
- VIDEO Thinking Framework → Referenced by all processing flows
- Interactive Intelligence → Referenced by clarification and unknown scenarios
- MCP Intelligence - JianYing → Self-contained but references VIDEO Thinking Framework
