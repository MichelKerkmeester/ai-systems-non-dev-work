---
title: "Rules - Human Voice - NL - v0.220"
description: "Dutch Human Voice hard blockers and structural rules every deliverable must pass."
trigger_phrases:
  - "dutch human voice rules"
  - "nederlandse hard blockers"
  - "verboden woorden"
  - "ai patroon detectie"
...
Defines the global Dutch Human Voice Rules: hard blockers, banned words and phrases, punctuation discipline, and AI-pattern detection that every Dutch deliverable must pass. It is the canonical, system-agnostic Dutch ruleset.

### When to Use

- Loaded ALWAYS when generating, editing, or reviewing Dutch content (instead of the English HVR)
- Checking Dutch output against hard blockers, banned words, and soft deductions
...
hvr_runtime:
  ...
  phase_2_audit:
    ...
    focus_areas:
      ...
      - "Unnatural Anglicisms or calques from English AI patterns (Section 7.8)"
...
- **reis (journey)**: context_dependent only (Section 10). Metaphorical blocked at -5, literal allowed.
- **ecosysteem (ecosystem)**: context_dependent (Section 10). Startup/partner metaphor blocked, biological allowed.
- **landschap (landscape)**: context_dependent (Section 10) for the word. Phrase "het landschap van" stays in banned_metaphors (Section 7.1).
- **verdieping (deep dive)**: context_dependent (Section 10) for noun. Verb "diep duiken in" remains hard_blocker (Section 8).
- **"Je bent niet de enige"**: phrase_hard_blocker only (Section 9). -5 takes precedence.
- **eigenlijk, gewoonweg, letterlijk, eenvoudigweg**: cut_always only (Section 7.3). Structural removal supersedes scoring.
...
These words trigger AUTOMATIC FAILURE in Dutch content. Never use them. Words requiring context checking are in Section 10.
...
soft_deductions_minus_1:
  ...
  filler_words: ["eerlijk gezegd", "om eerlijk te zijn"]  # eigenlijk, gewoonweg, eenvoudigweg, letterlijk covered by cut_always (Section 7.3)
...
pre_publish_checklist:
  ...
  dutch_specific:
    ...
    - "No Dutch AI customer service phrases (Section 9)"
    - "No literally translated English idioms — Amerikanismen (Section 7.8)"
...
Measurable targets for Dutch content quality. Use these to evaluate content during the Phase 2 audit (Section 3).
