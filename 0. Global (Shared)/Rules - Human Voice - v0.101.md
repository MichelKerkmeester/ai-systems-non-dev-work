...
- [0. 🎯 VOICE DIRECTIVES](#0-voice-directives)
...
voice_directives:
  active_voice:
    ...
    examples:
      - wrong: "The meeting was canceled by management."
        right: "Management canceled the meeting."
  ...
  simple_language:
    ...
    examples:
      - wrong: "We need to facilitate the optimization of our workflow processes."
